...
class TestSmokeTest():
  ...
  def test_join(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "email").send_keys("francillonsapio@gmail.com")
    self.driver.find_element(By.NAME, "cellphone").click()
    self.driver.find_element(By.NAME, "cellphone").send_keys("208-468-1122")
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.CSS_SELECTOR, ".myradio:nth-child(13)").click()
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.NAME, "websiteURL").click()
    self.driver.find_element(By.NAME, "websiteURL").send_keys("www.sapio.com")
    self.driver.find_element(By.CSS_SELECTOR, "textarea").click()
    self.driver.find_element(By.CSS_SELECTOR, "textarea").send_keys("It\'s a small business that tends to become great in the future.")
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.NAME, "websiteURL").click()
    self.driver.find_element(By.NAME, "websiteURL").send_keys("http://www.sapio.com")
    self.driver.find_element(By.NAME, "submit").click()
